// Generated by gencpp from file modrob_control_wiimote/State.msg
// DO NOT EDIT!


#ifndef MODROB_CONTROL_WIIMOTE_MESSAGE_STATE_H
#define MODROB_CONTROL_WIIMOTE_MESSAGE_STATE_H
...
#include <geometry_msgs/Vector3.h>
#include <geometry_msgs/Vector3.h>
#include <modrob_control_wiimote/IrSourceInfo.h>
...
struct State_
{
  ...
  _rumble_type rumble;
   ...
   typedef std::vector< ::modrob_control_wiimote::IrSourceInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::modrob_control_wiimote::IrSourceInfo_<ContainerAllocator> >::other >  _ir_tracking_type;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::modrob_control_wiimote::State_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::modrob_control_wiimote::State_<ContainerAllocator> const> ConstPtr;

}; // struct State_

typedef ::modrob_control_wiimote::State_<std::allocator<void> > State;

typedef boost::shared_ptr< ::modrob_control_wiimote::State > StatePtr;
typedef boost::shared_ptr< ::modrob_control_wiimote::State const> StateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::modrob_control_wiimote::State_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::modrob_control_wiimote::State_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::modrob_control_wiimote::State_<ContainerAllocator1> & lhs, const ::modrob_control_wiimote::State_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::modrob_control_wiimote::State_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::modrob_control_wiimote::State_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::modrob_control_wiimote::State_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::modrob_control_wiimote::State_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::modrob_control_wiimote::State_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::modrob_control_wiimote::State_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::modrob_control_wiimote::State_<ContainerAllocator> >
{
  ...
  static const char* value(const ::modrob_control_wiimote::State_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa69651e8129655c6ULL;
  static const uint64_t static_value2 = 0xed3c5039e468362cULL;
};

template<class ContainerAllocator>
struct DataType< ::modrob_control_wiimote::State_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::modrob_control_wiimote::State_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::modrob_control_wiimote::State_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::modrob_control_wiimote::State_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::modrob_control_wiimote::State_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.ir_tracking.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::modrob_control_wiimote::IrSourceInfo_<ContainerAllocator> >::stream(s, indent + "    ", v.ir_tracking[i]);
    }
...
#endif // MODROB_CONTROL_WIIMOTE_MESSAGE_STATE_H
