// Generated by gencpp from file modrob_simulation/JointDescription.msg
// DO NOT EDIT!


#ifndef MODROB_SIMULATION_MESSAGE_JOINTDESCRIPTION_H
#define MODROB_SIMULATION_MESSAGE_JOINTDESCRIPTION_H
...
struct JointDescription_
{
  ...
  _velocity_type velocity;
   ...
   typedef double _gear_ratio_type;
  ...
  typedef boost::shared_ptr< ::modrob_simulation::JointDescription_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::modrob_simulation::JointDescription_<ContainerAllocator> const> ConstPtr;

}; // struct JointDescription_

typedef ::modrob_simulation::JointDescription_<std::allocator<void> > JointDescription;

typedef boost::shared_ptr< ::modrob_simulation::JointDescription > JointDescriptionPtr;
typedef boost::shared_ptr< ::modrob_simulation::JointDescription const> JointDescriptionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::modrob_simulation::JointDescription_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::modrob_simulation::JointDescription_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::modrob_simulation::JointDescription_<ContainerAllocator1> & lhs, const ::modrob_simulation::JointDescription_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::modrob_simulation::JointDescription_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::modrob_simulation::JointDescription_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::modrob_simulation::JointDescription_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::modrob_simulation::JointDescription_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::modrob_simulation::JointDescription_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::modrob_simulation::JointDescription_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::modrob_simulation::JointDescription_<ContainerAllocator> >
{
  ...
  static const char* value(const ::modrob_simulation::JointDescription_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x540b4bd087e3ef07ULL;
  static const uint64_t static_value2 = 0x1377bab7fe16e997ULL;
};

template<class ContainerAllocator>
struct DataType< ::modrob_simulation::JointDescription_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::modrob_simulation::JointDescription_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::modrob_simulation::JointDescription_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::modrob_simulation::JointDescription_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::modrob_simulation::JointDescription_<ContainerAllocator>& v)
  {
    s << indent << "name: ";
    ...
    s << indent << "gear_ratio: ";
    Printer<double>::stream(s, indent + "  ", v.gear_ratio);
...
#endif // MODROB_SIMULATION_MESSAGE_JOINTDESCRIPTION_H
