// Generated by gencpp from file modrob_simulation/LinkVisual.msg
// DO NOT EDIT!


#ifndef MODROB_SIMULATION_MESSAGE_LINKVISUAL_H
#define MODROB_SIMULATION_MESSAGE_LINKVISUAL_H
...
struct LinkVisual_
{
  ...
  _color_a_type color_a;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _gazebo_material_type;
  _gazebo_material_type gazebo_material;
  ...
  typedef boost::shared_ptr< ::modrob_simulation::LinkVisual_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::modrob_simulation::LinkVisual_<ContainerAllocator> const> ConstPtr;

}; // struct LinkVisual_

typedef ::modrob_simulation::LinkVisual_<std::allocator<void> > LinkVisual;

typedef boost::shared_ptr< ::modrob_simulation::LinkVisual > LinkVisualPtr;
typedef boost::shared_ptr< ::modrob_simulation::LinkVisual const> LinkVisualConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::modrob_simulation::LinkVisual_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::modrob_simulation::LinkVisual_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::modrob_simulation::LinkVisual_<ContainerAllocator1> & lhs, const ::modrob_simulation::LinkVisual_<ContainerAllocator2> & rhs)
{
  return lhs.name == rhs.name &&
    ...
    lhs.gazebo_material == rhs.gazebo_material &&
...
template <class ContainerAllocator>
struct IsFixedSize< ::modrob_simulation::LinkVisual_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::modrob_simulation::LinkVisual_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::modrob_simulation::LinkVisual_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::modrob_simulation::LinkVisual_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::modrob_simulation::LinkVisual_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::modrob_simulation::LinkVisual_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::modrob_simulation::LinkVisual_<ContainerAllocator> >
{
  ...
  static const char* value(const ::modrob_simulation::LinkVisual_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x74676e346ad25138ULL;
  static const uint64_t static_value2 = 0xf4a19f88be4b498dULL;
};

template<class ContainerAllocator>
struct DataType< ::modrob_simulation::LinkVisual_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::modrob_simulation::LinkVisual_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::modrob_simulation::LinkVisual_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::modrob_simulation::LinkVisual_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::modrob_simulation::LinkVisual_<ContainerAllocator>& v)
  {
    s << indent << "name: ";
    ...
    s << indent << "gazebo_material: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.gazebo_material);
    s << indent << "texture: ";
...
#endif // MODROB_SIMULATION_MESSAGE_LINKVISUAL_H
