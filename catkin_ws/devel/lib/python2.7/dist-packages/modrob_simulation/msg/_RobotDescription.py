...
"""autogenerated by genpy from modrob_simulation/RobotDescription.msg. Do not edit."""
import codecs
import sys
...
class RobotDescription(genpy.Message):
  _md5sum = "b436ad26e4c0693d458d531e79ef7f82"
  _type = "modrob_simulation/RobotDescription"
...
float64 y
float64 z"""
  __slots__ = ['header','name','joints','links','base_pos']
  _slot_types = ['std_msgs/Header','string','modrob_simulation/JointDescription[]','modrob_simulation/LinkDescription[]','geometry_msgs/Vector3']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,joints,links,base_pos
    ...
    if args or kwds:
      ...
      if self.base_pos is None:
        self.base_pos = geometry_msgs.msg.Vector3()
    else:
      self.header = std_msgs.msg.Header()
      self.name = ''
      self.joints = []
    ...
    try:
      ...
      for val1 in self.links:
        ...
        for val2 in val1.link_collision:
          ...
          buff.write(_get_struct_3d().pack(_x.arg1, _x.arg2, _x.arg3))
      _x = self
      buff.write(_get_struct_3d().pack(_x.base_pos.x, _x.base_pos.y, _x.base_pos.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = modrob_simulation.msg.JointDescription()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
      ...
      self.links = []
      for i in range(0, length):
        val1 = modrob_simulation.msg.LinkDescription()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        val1.link_visual = []
        for i in range(0, length):
          val2 = modrob_simulation.msg.LinkVisual()
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end
          ...
          if python3:
            val2.gazebo_material = str[start:end].decode('utf-8', 'rosmsg')
          else:
            val2.gazebo_material = str[start:end]
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end
        ...
        val1.link_collision = []
        for i in range(0, length):
          val2 = modrob_simulation.msg.LinkCollision()
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end
      ...
      (_x.base_pos.x, _x.base_pos.y, _x.base_pos.z,) = _get_struct_3d().unpack(str[start:end])
      return self
