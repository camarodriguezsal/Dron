...
"""autogenerated by genpy from modrob_control_wiimote/State.msg. Do not edit."""
import codecs
import sys
...
import modrob_control_wiimote.msg
import std_msgs.msg

class State(genpy.Message):
  _md5sum = "a69651e8129655c6ed3c5039e468362c"
  _type = "modrob_control_wiimote/State"
...
"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','geometry_msgs/Vector3','float64[9]','geometry_msgs/Vector3','geometry_msgs/Vector3','float64[9]','geometry_msgs/Vector3','geometry_msgs/Vector3','float32[2]','float32[2]','bool[11]','bool[2]','bool[4]','bool','modrob_control_wiimote/IrSourceInfo[]','float32','float32','time','uint64']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = modrob_control_wiimote.msg.IrSourceInfo()
        _x = val1
        start = end
        end += 24
