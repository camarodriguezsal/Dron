...
"""autogenerated by genpy from modrob_workstation/LinkDescription.msg. Do not edit."""
import codecs
import sys
...
class LinkDescription(genpy.Message):
  _md5sum = "d72565d0e95e131a90ff696d5b4ff17f"
  _type = "modrob_workstation/LinkDescription"
...
float64 arg2    # depending on the chosen type either y or length
float64 arg3    # for boxes: z"""
  __slots__ = ['name','origin_x','origin_y','origin_z','origin_r','origin_p','origin_yy','mass','intertia_ixx','intertia_ixy','intertia_ixz','intertia_iyy','intertia_iyz','intertia_izz','link_visual','link_collision']
  _slot_types = ['string','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','modrob_workstation/LinkVisual[]','modrob_workstation/LinkCollision[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,origin_x,origin_y,origin_z,origin_r,origin_p,origin_yy,mass,intertia_ixx,intertia_ixy,intertia_ixz,intertia_iyy,intertia_iyz,intertia_izz,link_visual,link_collision
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = modrob_workstation.msg.LinkVisual()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
      ...
      self.link_collision = []
      for i in range(0, length):
        val1 = modrob_workstation.msg.LinkCollision()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
