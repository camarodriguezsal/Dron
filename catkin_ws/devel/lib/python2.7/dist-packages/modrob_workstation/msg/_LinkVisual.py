...
"""autogenerated by genpy from modrob_workstation/LinkVisual.msg. Do not edit."""
import codecs
import sys
...
class LinkVisual(genpy.Message):
  _md5sum = "0430b8a9f268ec9b2d7e3df97c5473f4"
  _type = "modrob_workstation/LinkVisual"
...
string texture"""
  __slots__ = ['name','origin_x','origin_y','origin_z','origin_r','origin_p','origin_yy','type','arg1','arg2','arg3','color_name','color_r','color_g','color_b','color_a','texture']
  _slot_types = ['string','float64','float64','float64','float64','float64','float64','string','float64','float64','float64','string','float64','float64','float64','float64','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,origin_x,origin_y,origin_z,origin_r,origin_p,origin_yy,type,arg1,arg2,arg3,color_name,color_r,color_g,color_b,color_a,texture
