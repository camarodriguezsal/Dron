...
class JointDescription {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.gear_ratio, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.gear_ratio = _deserializer.float64(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'modrob_simulation/JointDescription';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '540b4bd087e3ef071377bab7fe16e997';
  }
