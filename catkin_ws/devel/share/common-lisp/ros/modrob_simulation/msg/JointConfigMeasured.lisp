...
(cl:defmethod cl:initialize-instance :after ((m <JointConfigMeasured>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointConfigMeasured)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name modrob_simulation-msg:<JointConfigMeasured> is deprecated: use modrob_simulation-msg:JointConfigMeasured instead.")))
...
(cl:defmethod joint_temperature-val ((m <JointConfigMeasured>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader modrob_simulation-msg:joint_temperature-val is deprecated.  Use modrob_simulation-msg:joint_temperature instead.")
  (joint_temperature m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointConfigMeasured>)))
  ...
  "modrob_simulation/JointConfigMeasured")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointConfigMeasured)))
  "Returns string type for a message object of type 'JointConfigMeasured"
  "modrob_simulation/JointConfigMeasured")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointConfigMeasured>)))
  ...
  (cl:format cl:nil "# This message describes a joint movement~%~%# The angle the joint is currently at~%float64 joint_angle~%~%# The current velocity of the joint~%float64 joint_velocity~%~%# The acceleration the joint currently experiences~%float64 joint_acceleration~%~%# The torque the joint is delivering~%float64 joint_torque~%~%# The current temperature of the joint~%float64 joint_temperature~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointConfigMeasured)))
  "Returns full string definition for message of type 'JointConfigMeasured"
  (cl:format cl:nil "# This message describes a joint movement~%~%# The angle the joint is currently at~%float64 joint_angle~%~%# The current velocity of the joint~%float64 joint_velocity~%~%# The acceleration the joint currently experiences~%float64 joint_acceleration~%~%# The torque the joint is delivering~%float64 joint_torque~%~%# The current temperature of the joint~%float64 joint_temperature~%~%"))
