...
(cl:defmethod cl:initialize-instance :after ((m <IrSourceInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IrSourceInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name modrob_control_wiimote-msg:<IrSourceInfo> is deprecated: use modrob_control_wiimote-msg:IrSourceInfo instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <IrSourceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader modrob_control_wiimote-msg:x-val is deprecated.  Use modrob_control_wiimote-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <IrSourceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader modrob_control_wiimote-msg:y-val is deprecated.  Use modrob_control_wiimote-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'ir_size-val :lambda-list '(m))
(cl:defmethod ir_size-val ((m <IrSourceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader modrob_control_wiimote-msg:ir_size-val is deprecated.  Use modrob_control_wiimote-msg:ir_size instead.")
  (ir_size m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<IrSourceInfo>)))
  ...
  "modrob_control_wiimote/IrSourceInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IrSourceInfo)))
  "Returns string type for a message object of type 'IrSourceInfo"
  "modrob_control_wiimote/IrSourceInfo")
