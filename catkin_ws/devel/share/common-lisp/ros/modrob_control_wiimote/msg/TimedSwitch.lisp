...
(cl:defmethod cl:initialize-instance :after ((m <TimedSwitch>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimedSwitch)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name modrob_control_wiimote-msg:<TimedSwitch> is deprecated: use modrob_control_wiimote-msg:TimedSwitch instead.")))

(cl:ensure-generic-function 'switch_mode-val :lambda-list '(m))
(cl:defmethod switch_mode-val ((m <TimedSwitch>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader modrob_control_wiimote-msg:switch_mode-val is deprecated.  Use modrob_control_wiimote-msg:switch_mode instead.")
  (switch_mode m))

(cl:ensure-generic-function 'num_cycles-val :lambda-list '(m))
(cl:defmethod num_cycles-val ((m <TimedSwitch>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader modrob_control_wiimote-msg:num_cycles-val is deprecated.  Use modrob_control_wiimote-msg:num_cycles instead.")
  (num_cycles m))

(cl:ensure-generic-function 'pulse_pattern-val :lambda-list '(m))
(cl:defmethod pulse_pattern-val ((m <TimedSwitch>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader modrob_control_wiimote-msg:pulse_pattern-val is deprecated.  Use modrob_control_wiimote-msg:pulse_pattern instead.")
  (pulse_pattern m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TimedSwitch>)))
  ...
  "modrob_control_wiimote/TimedSwitch")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TimedSwitch)))
  "Returns string type for a message object of type 'TimedSwitch"
  "modrob_control_wiimote/TimedSwitch")
