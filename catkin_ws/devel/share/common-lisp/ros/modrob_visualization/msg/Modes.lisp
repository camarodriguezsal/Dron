...
(cl:in-package modrob_visualization-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Modes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Modes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name modrob_visualization-msg:<Modes> is deprecated: use modrob_visualization-msg:Modes instead.")))

(cl:ensure-generic-function 'configurable_mode-val :lambda-list '(m))
(cl:defmethod configurable_mode-val ((m <Modes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader modrob_visualization-msg:configurable_mode-val is deprecated.  Use modrob_visualization-msg:configurable_mode instead.")
  (configurable_mode m))

(cl:ensure-generic-function 'angle_mode-val :lambda-list '(m))
(cl:defmethod angle_mode-val ((m <Modes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader modrob_visualization-msg:angle_mode-val is deprecated.  Use modrob_visualization-msg:angle_mode instead.")
  (angle_mode m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Modes>)))
  ...
  (cl:format cl:nil "# this variable declares wheather we are inside the configurable state or not~%bool configurable_mode~%# this variable declares wheather torque mode or joint angles. True means we are using joint angles~%bool angle_mode~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Modes)))
  "Returns full string definition for message of type 'Modes"
  (cl:format cl:nil "# this variable declares wheather we are inside the configurable state or not~%bool configurable_mode~%# this variable declares wheather torque mode or joint angles. True means we are using joint angles~%bool angle_mode~%~%~%"))
